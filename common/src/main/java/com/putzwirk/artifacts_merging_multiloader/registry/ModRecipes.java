...
public class ModRecipes {
    ...
    public static final Identifier ARTIFACT_MERGING_ID = Ids.of(Constants.MOD_ID, ARTIFACT_MERGING_NAME);

    public static RecipeSerializer<ArtifactMergingRecipe> create() {
